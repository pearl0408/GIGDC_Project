...
public class Day4Panel4 : MonoBehaviour
{
    float fadeAlpha;
    ...
    IEnumerator nextGo()
    {
        ...
        while (fadeAlpha < 1.0f)
        {
            ...
            food.GetComponent<Image>().color = new Color(food.GetComponent<Image>().color.r, food.GetComponent<Image>().color.g, food.GetComponent<Image>().color.b, fadeAlpha);
        }
